"""Run a paper-aligned RL benchmark in known-defense mode.
...
Primary use: estimate the upper-bound attack effect of the latest RL attacker when the defense type is known.
"""
...
DEFAULT_ARGS = [
    ...
    "0.1",
    "--output_root",
    "fl_sandbox/outputs/rl_known_defense",
    "--tb_root",
    "fl_sandbox/runs/rl_known_defense",
]
...
def main(argv: Optional[list[str]] = None) -> None:
    run_experiment_main(
        ...
        description="Run a paper-style RL attack with known fixed defense",
    )
