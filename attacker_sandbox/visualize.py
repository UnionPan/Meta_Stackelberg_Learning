"""Visualization helpers for standalone attacker validation."""
...
def plot_series(
    ...
    """Plot a simple round-wise metric curve."""
    values = list(values)
...
def plot_dual_series(
    ...
    """Plot two round-wise series on the same axes."""
...
def plot_client_metric_heatmap(
    ...
    """Plot a round-by-client heatmap for a client metric table."""
    if not rows:
...
def plot_xy_series(
    ...
    """Plot a metric against a custom x-axis such as wall-clock time."""
...
def plot_mean_with_band(
    ...
    """Plot mean trajectory with a one-standard-deviation band."""
...
def plot_round_boxplot(
    ...
    """Plot a per-round boxplot for client-level distributions."""
